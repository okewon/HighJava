...
public class T15_TableViewTest extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		ObservableList<Member> data = FXCollections.observableArrayList(
				new Member("이재호", "jaeho", 22, "2222-2222", "인천"), new Member("심윤희", "younhee", 33, "3333-2222", "대전3"),
				new Member("전영현", "0hun", 44, "4444-2222", "부여"), new Member("이종우", "jongu", 55, "5555-2222", "대전"));
		...
		btnTest1.setOnAction(e -> {
			//TextField, TextArea등 문자를 입력하는 객체를 ReadOnly를 설정하는 메서드 -> setEditable(0
			//이 메서드에 true를 설정하면 '입력가능'
			//false를 설정하면 '읽기전용'이 된다.
			txtKorName.setEditable(false);
			txtEngName.setEditable(false);
			
			//객체를 활성화 또는 비활성화시키는 메서드 => setDisabled()
		...
		Button btnTest2 = new Button("속성 연습");
