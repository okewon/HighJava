...
public class T11_ComboBoxTest2 extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		/*
		 * // ComboBox를 setOnAction 처리하기 combo.setOnAction(new
		 * EventHandler<ActionEvent>() {
		 * 
		 * @Override public void handle(ActionEvent event) { // 현재 선택한 데이터 구하기 MyFriend
		 * data = combo.getSelectionModel().getSelectedItem();
		 * 
